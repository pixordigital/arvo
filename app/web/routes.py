...
NAV = [
    ...
    ("Deals", "/deals", "deals", '<rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/>'),
    ...
    ("Actions", "/actions", "actions", '<circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/>'),
